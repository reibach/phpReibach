...
else
{
	...
	//
	$query = $db->Execute("SELECT POSGROUPID, DESCRIPTION FROM posgroup WHERE POSGROUPID=$PosGroupID");
	...
	$query1 = $db->Execute("SELECT POS_NAME FROM article WHERE POS_NAME='$Pos_Name'");
	...
	{
		$query2 = "INSERT INTO article (POSITIONID, POS_ACTIVE, POS_NAME, POS_DESC, POS_PRICE, POS_TAX, POSGROUPID, POS_GROUP, NOTE, CREATEDBY, MODIFIEDBY, USERGROUP1, USERGROUP2, CREATED, MODIFIED)";
