...
//
$query1 = $db->Execute("SELECT POSGROUPID, DESCRIPTION FROM posgroup WHERE POSGROUPID=$PosGroupID");
...
{
	$query2 = $db->Execute("SELECT POSITIONID, POS_NAME FROM article WHERE POS_NAME='$Pos_Name' AND POSITIONID != $posID");
	...
	{
		$query3 = "UPDATE article SET POS_ACTIVE='$Pos_Active', POS_NAME='$Pos_Name', POS_DESC='$Pos_Desc', POS_PRICE='$Pos_Price', POS_TAX='$Pos_Tax', POSGROUPID='$PosGroupID', POS_GROUP='$Pos_Group', NOTE='$Note', MODIFIEDBY='$_SESSION[Username]', MODIFIED='$CurrentDateTime' WHERE POSITIONID=$posID";
