...
//
$query1 = $db->Execute("SELECT INVOICEID from payment WHERE CANCELED=2 AND INVOICEID=$invoiceID");
...
if (!$numrows1)
{
	...
	//
	$query2 = "UPDATE invoice SET CANCELED=1 WHERE INVOICEID=$invoiceID";
