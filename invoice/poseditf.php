...
$query = "UPDATE tmp_invoice SET MYID='$myID', INVOICEID='$invoiceID', POSITIONID=$PosID, USERNAME='$_SESSION[Username]', POS_DESC='$Pos_Desc', POS_QUANTITY='$Pos_Quantity', POS_PRICE='$Pos_Price', TAX='$Pos_Tax', TAX_MULTI='$Pos_Tax_Multi', TAX_DIVIDE='$Pos_Tax_Divide', TAX_DESC='$Pos_Tax_Desc', POS_GROUP='$Pos_Group' WHERE TMP_INVOICEID=$tmpPosID";
