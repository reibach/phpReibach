...
{
	$query = $db->Execute("SELECT A.MYID, A.FIRSTNAME, A.LASTNAME, A.COMPANY, I.CREATEDBY, I.INVOICEID, I.MYID, DATE_FORMAT(I.INVOICE_DATE,'%d.%m.%Y') AS INVOICE_DATE, I.TOTAL_AMOUNT, I.PAID, I.SUM_PAID, I.CANCELED FROM invoice AS I, addressbook AS A WHERE CANCELED=1 AND A.MYID=I.MYID AND I.INVOICEID LIKE '%$InvoiceID1%'
...
{
	$query = $db->Execute("SELECT A.MYID, A.FIRSTNAME, A.LASTNAME, A.COMPANY, I.CREATEDBY, I.INVOICEID, I.MYID, DATE_FORMAT(I.INVOICE_DATE,'%d.%m.%Y') AS INVOICE_DATE, I.TOTAL_AMOUNT, I.PAID, I.SUM_PAID, I.CANCELED FROM invoice AS I, addressbook AS A WHERE A.MYID=I.MYID AND I.INVOICEID LIKE '%$InvoiceID1%'
			AND I.MYID LIKE '%$CustomerID1' AND I.TOTAL_AMOUNT LIKE '%$Total1%' AND ( A.FIRSTNAME LIKE '%$Customer1%' OR A.LASTNAME LIKE '%$Customer1%' OR A.COMPANY LIKE '%$Customer1%' )
			AND I.INVOICE_DATE >= '$DateFrom1' AND I.INVOICE_DATE <= '$DateTill1' ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
}
else
{
	$query = $db->Execute("SELECT A.MYID, A.FIRSTNAME, A.LASTNAME, A.COMPANY, I.CREATEDBY, I.INVOICEID, I.MYID, DATE_FORMAT(I.INVOICE_DATE,'%d.%m.%Y') AS INVOICE_DATE, I.TOTAL_AMOUNT, I.PAID, I.SUM_PAID, I.CANCELED FROM invoice AS I, addressbook AS A WHERE CANCELED=2 AND A.MYID=I.MYID AND I.INVOICEID LIKE '%$InvoiceID1%'
			AND I.MYID LIKE '%$CustomerID1' AND I.TOTAL_AMOUNT LIKE '%$Total1%' AND ( A.FIRSTNAME LIKE '%$Customer1%' OR A.LASTNAME LIKE '%$Customer1%' OR A.COMPANY LIKE '%$Customer1%' )
			AND I.INVOICE_DATE >= '$DateFrom1' AND I.INVOICE_DATE <= '$DateTill1' ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
}
...
if (!$query)
	...
	if(isset($Canceled) && $Canceled == 1)
	{
		$query1 = $db->Execute("SELECT A.MYID, A.FIRSTNAME, A.LASTNAME, A.COMPANY, I.INVOICEID, I.MYID, I.TOTAL_AMOUNT, I.SUM_PAID FROM addressbook AS A, invoice AS I WHERE I.CANCELED=1 AND A.MYID=I.MYID AND I.INVOICEID LIKE '%$InvoiceID1%' AND I.MYID LIKE '%$CustomerID1' AND I.TOTAL_AMOUNT LIKE '%$Total1%'
	...
	{
		$query1 = $db->Execute("SELECT A.MYID, A.FIRSTNAME, A.LASTNAME, A.COMPANY, I.INVOICEID, I.MYID, I.TOTAL_AMOUNT, I.SUM_PAID FROM addressbook AS A, invoice AS I WHERE A.MYID=I.MYID AND I.INVOICEID LIKE '%$InvoiceID1%' AND I.MYID LIKE '%$CustomerID1' AND I.TOTAL_AMOUNT LIKE '%$Total1%'
			AND ( A.FIRSTNAME LIKE '%$Customer1%' OR A.LASTNAME LIKE '%$Customer1%' OR A.COMPANY LIKE '%$Customer1%' )
			AND I.INVOICE_DATE >= '$DateFrom1' AND I.INVOICE_DATE <= '$DateTill1'");
	}
	else
	{
		$query1 = $db->Execute("SELECT A.MYID, A.FIRSTNAME, A.LASTNAME, A.COMPANY, I.INVOICEID, I.MYID, I.TOTAL_AMOUNT, I.SUM_PAID FROM addressbook AS A, invoice AS I WHERE I.CANCELED=2 AND A.MYID=I.MYID AND I.INVOICEID LIKE '%$InvoiceID1%' AND I.MYID LIKE '%$CustomerID1' AND I.TOTAL_AMOUNT LIKE '%$Total1%'
			AND ( A.FIRSTNAME LIKE '%$Customer1%' OR A.LASTNAME LIKE '%$Customer1%' OR A.COMPANY LIKE '%$Customer1%' )
			AND I.INVOICE_DATE >= '$DateFrom1' AND I.INVOICE_DATE <= '$DateTill1'");
	}
