...
//
$query = $db->Execute("SELECT COMPANY_NAME, COMPANY_PHONE, COMPANY_EMAIL, SETTINGID FROM setting ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
if (!$query)
	...
	// Count MaxRows
	//
	$query1 = $db->Execute("SELECT SETTINGID FROM setting");
