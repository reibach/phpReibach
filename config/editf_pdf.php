...
{
	$query = $db->Execute("UPDATE setting SET COMPANY_LOGO='$D_PDF_Company_Logo', PDF_COMPANY_LOGO_WIDTH='$D_PDF_Company_Logo_Width', PDF_COMPANY_LOGO_HEIGHT='$D_PDF_Company_Logo_Height', PDF_FONT='$D_PDF_Font', PDF_FONT_SIZE1='$D_PDF_Text1', PDF_FONT_SIZE2='$D_PDF_Text2', PDF_TYPE_HEIGHT='$D_PDF_Text3', PDF_DIR='$D_PDF_Directory', PDF_ATTACHMENT_TEXT='$D_PDF_Attachment_Text', MODIFIEDBY='$_SESSION[Username]' WHERE SETTINGID=$settingID");
