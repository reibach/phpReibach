...
{
	$query = $db->Execute("UPDATE setting SET PRINT_COMPANY_DATA='$D_Print_Company_Data', PRINT_POSITION_NAME='$D_Print_Position_Name', EMAIL_INTERNAL='$D_Email_Internal', EMAIL_USE_SIGNATURE='$D_Email_Use_Signature', EMAIL_SIGNATURE='$D_Email_Signature', INVENTORY_CHECK_ACTIVE='2', REMINDER='$D_Reminder', REMINDER_DAYS='$D_Reminder_Days', REMINDER_PRICE='0.00', ENTRYS_PER_PAGE='$D_Entries_Per_Page', SESSION_SEC='$D_Session_Sec', MODIFIEDBY='$_SESSION[Username]' WHERE SETTINGID=$settingID");
