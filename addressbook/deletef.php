...
else
{
	...
	$query1 = $db->Execute("SELECT MYID FROM offer WHERE MYID=$myID");
	$query2 = $db->Execute("SELECT MYID FROM invoice WHERE MYID=$myID");
	...
	else
	{
		...
		$query4 = "DELETE FROM addressbook WHERE MYID=$myID";
