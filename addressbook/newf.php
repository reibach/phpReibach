...
else
{
	...
	$query1 = $db->Execute("SELECT FIRSTNAME, LASTNAME, ADDRESS, POSTALCODE, CITY FROM addressbook WHERE FIRSTNAME='$firstname' AND LASTNAME='$lastname' AND ADDRESS='$address' AND POSTALCODE='$postalcode' AND CITY='$city'");
