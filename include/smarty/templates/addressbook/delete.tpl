...
<form id="Search" name="Search" action="deletef.php?{$Session}" method="post">
...
<tr><td align="center" colspan="2"><h2>{$Addressbook} - {$Delete}</h2></td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="center" colspan="2">{$Customer_No} {$myID}, {$FIRSTNAME} {$LASTNAME} {$COMPANY} ?</td></tr>
<tr><td></td></tr>
