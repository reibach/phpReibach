...
<tr><td align="center" colspan="5"><h2>{$Addressbook} - {$List}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=LASTNAME&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Last_Name} ASC" alt="{$SortMsg} {$Last_Name} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=LASTNAME&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Last_Name} DESC" alt="{$SortMsg} {$Last_Name} DESC" /></a>
</td>
<td nowrap="nowrap" align="left">{$First_Name}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=FIRSTNAME&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$First_Name} ASC" alt="{$SortMsg} {$First_Name} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=FIRSTNAME&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$First_Name} DESC" alt="{$SortMsg} {$First_Name} DESC" /></a>
</td>
<td nowrap="nowrap" align="left">{$Company_Name}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Company_Name} ASC" alt="{$SortMsg} {$Company_Name} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Company_Name} DESC" alt="{$SortMsg} {$Company_Name} DESC" /></a>
</td>
<td nowrap="nowrap" align="left">{$Phone_Work}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=PHONEWORK&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Phone_Work} ASC" alt="{$SortMsg} {$Phone_Work} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=PHONEWORK&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Phone_Work} DESC" alt="{$SortMsg} {$Phone_Work} DESC" /></a>
</td>
...
<td valign="top" align="left"><a name="{$customer.MYID}" title="{$AllInformation} {$customer.FIRSTNAME} {$customer.LASTNAME} {$customer.COMPANY}" class="ninfolink" href="info.php?myID={$customer.MYID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
...
<td valign="top" align="center"><a href="edit.php?myID={$customer.MYID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td>
{else}
<td></td>
{/if}
