...
<tr>
	...
	{if $Type eq "Info"}
		[&nbsp;<a title="{$BackMsg} - {$Addressbook} - {$Auth_Info}" class="ninfolink" href="info_a.php?myID={$myID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Customer={$Customer}{$Searchstring}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	{elseif $infoID eq 9}
...
&nbsp;
[&nbsp;<a title="{$Auth_Info}" class="nmenulink" href="edit_a.php?myID={$MYID}&amp;infoID={$infoID}&amp;page={$page}&amp;Type={$Type}&amp;Customer={$Customer}{$Searchstring}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><b>{$Auth_Info}</b></a>&nbsp;]
</td></tr>
<tr><td>&nbsp;</td></tr>


<tr><td valign="middle" align="right" width="30%">{$User_Active}:</td><td class="dbTxt" valign="middle" align="left" width="70%">
...
<tr>
	<td valign="middle" align="right" width="30%"><b>{$Username}</b>:
	</td>
	<td class="dbTxt" valign="middle" align="left" width="70%"><input class="form_input" type="text" name="UserName" size="22" value="{$USERNAME}" />
	</td>
</tr>
<tr>
	<td valign="middle" align="right" width="30%">{$Language}:
	</td>
...
<tr>
	<td valign="middle" align="right" width="30%"><b>{$Password}</b>:
	</td>
	<td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="password" name="Password1" size="22" value="{$PASSWORD}" />
	</td>
</tr>
<tr>
	<td valign="middle" align="right" width="30%"><b>{$Repeat_Password}</b>:
	</td>
	<td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="password" name="Password2" size="22" value="{$PASSWORD}" />
	</td>
</tr>
<tr><td>&nbsp;</td></tr>
