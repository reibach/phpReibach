...
<tr>
<td align="center" colspan="2"><h2>{$Invoice} - {$Cancel}</h2><br />
...
<form id="CancelInvoice" name="CancelInvoice" action="cancelf.php?{$Session}" method="post">
...
<input type="submit" class="button" title="{$Invoice} - {$Cancel}" value="{$Cancel}" />
</form>
</td>
</tr>
</table></td></tr></table>
