...
<tr><td align="center" colspan="8"><h2>{$Invoice} - {$SearchResult}</h2></td></tr>
<tr><td align="center" colspan="8">{$DateMsg} {$DateFrom} {$DateFrom1} {$DateTill} {$DateTill1}</td></tr>
<tr><td>&nbsp;</td></tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=INVOICEID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Invoice_No} ASC" alt="{$SortMsg} {$Invoice_No} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=INVOICEID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Invoice_No} DESC" alt="{$SortMsg} {$Invoice_No} DESC" /></a>
</td>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.INVOICE_DATE&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$DateMsg} ASC" alt="{$SortMsg} {$DateMsg} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.INVOICE_DATE&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$DateMsg} DESC" alt="{$SortMsg} {$DateMsg} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Invoice_Amount} {$Invoice_Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TOTAL_AMOUNT&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Invoice_Amount} ASC" alt="{$SortMsg} {$Invoice_Amount} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TOTAL_AMOUNT&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Invoice_Amount} DESC" alt="{$SortMsg} {$Invoice_Amount} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Open_Account}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TOTAL_AMOUNT-SUM_PAID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Open_Account} ASC" alt="{$SortMsg} {$Open_Account} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TOTAL_AMOUNT-SUM_PAID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Open_Account} DESC" alt="{$SortMsg} {$Open_Account} DESC" /></a>
</td>
...
<td valign="top" align="left"><a name="{$invoice.INVOICEID}" title="{$AllInformation} {$Invoice_No} {$invoice.INVOICEID}" class="ninfolink" href="info.php?myID={$invoice.MYID}&amp;invoiceID={$invoice.INVOICEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}">
...
{if $invoice.CANCELED neq 1}
	...
	{if $smarty.session.Username and ( $smarty.session.Username eq $Root or $smarty.session.Username eq $invoice.CREATEDBY)}
		{if $invoice.PAID eq '2'}
			<td valign="top" align="center"><a href="edit.php?invoiceID={$invoice.INVOICEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td>
...
{if $smarty.session.Username and ( $smarty.session.Username eq $Root )}
	...
	<tr><td valign="top" align="right" colspan="5"><b>{$Invoice_Amount} {$Searchresult} {$Invoice_Currency}</b>:</td><td valign="top" align="right" colspan="3"><b>{$TOTAL_AMOUNT|number_format}</b></td></tr>
{/if}
<tr><td>&nbsp;</td></tr>
