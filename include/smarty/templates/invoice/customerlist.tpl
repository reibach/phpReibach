...
href="../offer/list.php?{$Session}">{$Offer} - {$List}</a></td></tr>
...
{if $invoiceID}
	<td valign="top" align="center"><a href="edit.php?myID={$customer.MYID}&amp;tmpID={$invoiceID}&amp;page={$page}&amp;invoiceID={$invoiceID}&amp;infoID={$infoID}&amp;messageID={$messageID}&amp;InvoiceDate={$InvoiceDate}&amp;MethodOfPayment={$MethodOfPayment}&amp;MethodOfPaymentDate={$MethodOfPaymentDate}&amp;Pos_Quantity={$Pos_Quantity}&amp;Note={$Note}&amp;Order={$Order}&amp;Sort={$Sort}&amp;tmpID=1&amp;Canceled={$Canceled}{$Searchstring}&amp;{$Session}"><img border="0" src="../images/bill.png" title="{$Issue_Offer} {$customer.FIRSTNAME} {$customer.LASTNAME} {$customer.COMPANY}" alt="{$Issue_Offer} {$customer.FIRSTNAME} {$customer.LASTNAME} {$customer.COMPANY}" /></a></td>
{else}
	<td valign="top" align="center"><a href="new.php?myID={$customer.MYID}&amp;tmpID={$invoiceID}&amp;page={$page}&amp;invoiceID={$invoiceID}&amp;infoID={$infoID}&amp;messageID={$messageID}&amp;InvoiceDate={$InvoiceDate}&amp;MethodOfPayment={$MethodOfPayment}&amp;MethodOfPaymentDate={$MethodOfPaymentDate}&amp;Pos_Quantity={$Pos_Quantity}&amp;Note={$Note}&amp;Order={$Order}&amp;Sort={$Sort}&amp;tmpID=1&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/bill.png" title="{$Issue_Invoice} {$customer.FIRSTNAME} {$customer.LASTNAME} {$customer.COMPANY}" alt="{$Issue_Invoice} {$customer.FIRSTNAME} {$customer.LASTNAME} {$customer.COMPANY}" /></a></td>
{/if}
</tr>
{/foreach}
{/if}
