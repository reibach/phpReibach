...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$PositionGroupSub} - {$New}"
...
<tr><td align="center" colspan="2"><h2>{$PositionGroupSub} - {$New}</h2></td></tr>
...
<tr><td valign="middle" align="center" colspan="2"><textarea title="{$PositionGroupSub}" class="form_textarea" name="CPosGroup" rows="5" cols="40">{$CPosGroup}</textarea></td></tr>
<tr><td></td></tr>
