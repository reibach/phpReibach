...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Useradministration} - {$New}"
...
<tr><td align="center" colspan="2"><h2>{$Useradministration} - {$New}</h2></td></tr>
{if $smarty.session.NewID and ( $smarty.session.NewID eq 1 )}
	<tr><td align="center" colspan="2" class="greentxt">{$NewEntry} {$EntryNo} {$UserID}</td></tr>
{/if}
<tr><td></td></tr>
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$UserID+1} ]</td></tr>
<tr><td></td></tr>
...
<tr><td valign="middle" align="right" width="40%"><b>{$User_Name}</b>:</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$User_Name}" type="text" name="UserName" size="30" value="{$UserName}" /></td></tr>
...
<tr><td valign="middle" align="right" width="40%"><b>{$Password}</b>:</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$Password}" type="password" name="Password1" size="30" value="" /></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$Repeat_Password}</b>:</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$Repeat_Password}" type="password" name="Password2" size="30" value="" /></td></tr>
<tr><td></td></tr>
