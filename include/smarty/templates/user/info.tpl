...
<tr><td align="center" colspan="2"><h2>{$Useradministration} - {$Info}</h2></td></tr>
<tr><td></td></tr>
{if $smarty.session.Username and ( $smarty.session.Username eq $Root or $smarty.session.Usergroup1 eq $AdminGroup1 or $smarty.session.Usergroup2 eq $AdminGroup2)}
	<tr><td align="center" colspan="2">
	[&nbsp;<a title="{$Editentry}" class="nmenulink" href="edit.php?userID={$userID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;UserActive_1={$UserActive_1}&amp;FullName_1={$FullName_1}&amp;UserName_1={$UserName_1}&amp;UserLanguage_1={$UserLanguage_1}&amp;UserGroup_1={$UserGroup_1}&amp;{$Session}">{$Edit}</a>
	&nbsp;|&nbsp;<a title="{$Deleteentry}" class="nmenulink" href="delete.php?userID={$userID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;UserActive_1={$UserActive_1}&amp;FullName_1={$FullName_1}&amp;UserName_1={$UserName_1}&amp;UserLanguage_1={$UserLanguage_1}&amp;UserGroup_1={$UserGroup_1}&amp;{$Session}">{$Delete}</a>&nbsp;]
	</td></tr>
{elseif $smarty.session.Username and ( $smarty.session.Username eq $USERNAME and $smarty.session.Username neq $Root and $smarty.session.Usergroup1 neq $AdminGroup1 and $smarty.session.Usergroup2 neq $AdminGroup2)}
	<tr><td align="center" colspan="2">
	[&nbsp;<a title="{$Editentry}" class="nmenulink" href="edit.php?userID={$userID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;UserActive_1={$UserActive_1}&amp;FullName_1={$FullName_1}&amp;UserName_1={$UserName_1}&amp;UserLanguage_1={$UserLanguage_1}&amp;UserGroup_1={$UserGroup_1}&amp;{$Session}">{$Edit}</a>&nbsp;]
	</td></tr>
{/if}
<tr><td></td></tr>
<tr><td align="center" colspan="2">{$AllInformation} {$EntryNo} {$userID}</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%">{$User_Active}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$USERACTIVE}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$Full_Name}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$FULLNAME}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$User_Name}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$USERNAME}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$User_Group}&nbsp;1:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$USERGROUP1}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$User_Group}&nbsp;2:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$USERGROUP2}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$Language}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$LANGUAGE}</td></tr>
<tr><td></td></tr>
{* Display back button *}
