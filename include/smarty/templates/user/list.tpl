...
<tr><td align="center" colspan="5"><h2>{$Useradministration} - {$List}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
...
<td valign="top" align="left"><a name="{$user.USERID}" title="{$AllInformation} {$EntryNo} {$user.USERID} - {$user.FULLNAME}" class="ninfolink" href="info.php?userID={$user.USERID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
{if $user.FULLNAME}
	{$user.FULLNAME}
{else}
	&nbsp;i&nbsp;
