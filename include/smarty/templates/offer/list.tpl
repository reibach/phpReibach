...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=OFFERID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Offer_No} ASC" alt="{$SortMsg} {$Offer_No} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=OFFERID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Offer_No} DESC" alt="{$SortMsg} {$Offer_No} DESC" /></a>
</td>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=O.OFFER_DATE&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$DateMsg} ASC" alt="{$SortMsg} {$DateMsg} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=O.OFFER_DATE&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$DateMsg} DESC" alt="{$SortMsg} {$DateMsg} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Offer_Amount} {$Offer_Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TOTAL_AMOUNT&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Offer_Amount} ASC" alt="{$SortMsg} {$Offer_Amount} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TOTAL_AMOUNT&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Offer_Amount} DESC" alt="{$SortMsg} {$Offer_Amount} DESC" /></a>
</td>
...
<td valign="top" align="left"><a name="{$offer.OFFERID}" title="{$AllInformation} {$Offer_No} {$offer.OFFERID}" class="ninfolink" href="info.php?myID={$offer.MYID}&amp;offerID={$offer.OFFERID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}">
{$offer.OFFERID}</a></td>
{if $offer.CANCELED neq 1}
	...
	{if $smarty.session.Username and ( $smarty.session.Username eq $Root or $smarty.session.Username eq $offer.CREATEDBY)}
		{if $offer.STATUS neq 3}
			<td valign="top" align="center"><a href="edit.php?offerID={$offer.OFFERID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td>
...
<tr><td valign="top" align="right" colspan="5"><b>{$Offer_Amount} {$Offer_Currency}</b>:</td><td valign="top" align="right" colspan="3"><b>{$TOTAL_OFFER|number_format}</b></td></tr>
{/if}
<tr><td>&nbsp;</td></tr>
