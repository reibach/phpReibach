...
<tr><td align="left" class="phprechnung_menu_sub"><a accesskey="1" title="{$ArticleGroupsSub} - {$List}"
...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="3" title="{$ArticleGroupsSub} - {$Search}"
...
<tr><td align="center" colspan="2"><h2>{$ArticleGroupsSub} - {$Search}</h2></td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="center" colspan="2"><b>{$ArticleGroupsSub}:</b></td></tr>
<tr><td valign="middle" align="center" colspan="2"><textarea title="{$ArticleGroupsSub}" class="form_textarea" name="Description_1" rows="5" cols="40"></textarea></td></tr>
<tr><td></td></tr>
