...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="1" title="{$MethodOfPayment} - {$List}"
...
<tr><td align="left" class="phprechnung_menu_sub"><a accesskey="3" title="{$MethodOfPayment} - {$Search}"
...
<tr><td align="center" colspan="5"><h2>{$MethodOfPayment} - {$Searchresult}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
...
{if $smarty.session.EditID and ( $smarty.session.EditID eq 1 )}
	<tr><td align="center" colspan="4" class="greentxt">{$EntryChanged} {$EntryNo} {$methodpayID}</td></tr>
{/if}
{if $smarty.session.DeleteID and ( $smarty.session.DeleteID eq 1 )}
	<tr><td align="center" colspan="4" class="greentxt">{$EntryDeleted} {$EntryNo} {$methodpayID}</td></tr>
{/if}
<tr><td></td></tr>
<tr class="mblueTD">
<td nowrap="nowrap" align="left">{$EntryNo}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=METHODOFPAYID&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC" alt="{$SortMsg} {$EntryNo} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=METHODOFPAYID&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$EntryNo} DESC" alt="{$SortMsg} {$EntryNo} DESC" /></a>&nbsp;</td>
<td nowrap="nowrap" align="left">{$MethodOfPayment}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$MethodOfPayment} ASC" alt="{$SortMsg} {$MethodOfPayment} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$MethodOfPayment} DESC" alt="{$SortMsg} {$MethodOfPayment} DESC" /></a>&nbsp;</td>
...
{else}
{foreach from=$MethodOfPaymentData item=methodpay}
	<tr class="{cycle values="grayTD,wTD"}">
	<td valign="top" align="left"><a name="{$methodpay.METHODOFPAYID}" title="{$AllInformation} {$EntryNo} {$methodpay.METHODOFPAYID} - {$methodpay.DESCRIPTION}" class="ninfolink" href="info.php?methodpayID={$methodpay.METHODOFPAYID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">
	{$methodpay.METHODOFPAYID}</a></td><td valign="top" align="left">
	{$methodpay.DESCRIPTION}</td>
	{if $smarty.session.Username and ( $smarty.session.Username == $Root or $smarty.session.Usergroup1 == $AdminGroup1 or $smarty.session.Usergroup2 == $AdminGroup2 and $methodpay.METHODOFPAYID != 2)}
		<td valign="top" align="center"><a href="edit.php?methodpayID={$methodpay.METHODOFPAYID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td></tr>
	{else}
		<td></td></tr>
	{/if}
{/foreach}
