...
{else}
	<body onload="document.New.Method_Of_Payment.focus();">
{/if}
...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$MethodOfPayment} - {$New}"
...
<form id="New" name="New" action="newf.php?{$Session}#{$methodpayID}" method="post">
...
<tr><td align="center" colspan="2"><h2>{$MethodOfPayment} - {$New}</h2></td></tr>
{if $smarty.session.NewID and ( $smarty.session.NewID eq 1 )}
	<tr><td align="center" colspan="2" class="greentxt">{$NewEntry} {$EntryNo} {$MethodPayID}</td></tr>
{/if}
<tr><td></td></tr>
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$MethodPayID+1} ]</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$MethodOfPayment}:</b>&nbsp;</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$MethodOfPayment}" type="text" name="Method_Of_Payment" size="30" value="{$Method_Of_Payment}" /></td></tr>
<tr><td></td></tr>
