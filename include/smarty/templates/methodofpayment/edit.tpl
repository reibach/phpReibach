...
{else}
	<body onload="document.Edit.Method_Of_Payment.focus();">
{/if}
...
<tr><td align="center" colspan="2"><h2>{$MethodOfPayment} - {$Edit}</h2></td></tr>
<tr><td></td></tr>
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$methodpayID} ]</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$MethodOfPayment}:</b>&nbsp;</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$MethodOfPayment}" type="text" name="Method_Of_Payment" size="30" value="{$METHODOFPAYMENT}" /></td></tr>
<tr><td></td></tr>
<tr><td valign="top" align="center" colspan="2">
<input type="hidden" name="page" value="{$page}" />
<input type="hidden" name="methodpayID" value="{$methodpayID}" />
