...
<tr><td align="center" colspan="5"><h2>{$Message} - {$List}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC" alt="{$SortMsg} {$EntryNo} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$EntryNo} DESC" alt="{$SortMsg} {$EntryNo} DESC" /></a>&nbsp;</td>
<td nowrap="nowrap" align="left">{$Message}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Message} ASC" alt="{$SortMsg} {$Message} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Message} DESC" alt="{$SortMsg} {$Message} DESC" /></a>&nbsp;</td>
...
{foreach from=$MessageData item=message}
	...
	<td valign="top" align="left"><a name="{$message.MESSAGEID}" title="{$AllInformation} {$EntryNo} {$message.MESSAGEID} - {$message.DESCRIPTION}" class="ninfolink" href="info.php?messageID={$message.MESSAGEID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
	...
	{if $smarty.session.Username and ( $smarty.session.Username == $Root or $smarty.session.Usergroup1 == $AdminGroup1 or $smarty.session.Usergroup2 == $AdminGroup2)}
		<td valign="top" align="center"><a href="edit.php?messageID={$message.MESSAGEID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td></tr>
	{else}
		<td></td></tr>
	{/if}
{/foreach}
