...
{if $smarty.session.Username and ( $smarty.session.Username eq $Root)}
	...
	[&nbsp;<a title="{$Editentry}" class="nmenulink" href="edit.php?messageID={$messageID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">{$Edit}</a>
	&nbsp;|&nbsp;<a title="{$Deleteentry}" class="nmenulink" href="delete.php?messageID={$messageID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">{$Delete}</a>&nbsp;]
	</td></tr>
{/if}
<tr><td></td></tr>
<tr><td align="center" colspan="2">{$AllInformation} {$EntryNo} {$messageID}</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="center" colspan="2"><b>{$Message}:</b></td></tr>
<tr><td valign="middle" align="center" colspan="2">{$MESSAGE|nl2br}</td></tr>
<tr><td></td></tr>
{* Display back button *}
