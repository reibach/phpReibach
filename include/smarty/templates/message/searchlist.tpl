...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="1" title="{$Message} - {$List}"
...
<tr><td align="left" class="phprechnung_menu_sub"><a accesskey="3" title="{$Message} - {$Search}"
...
<tr><td align="center" colspan="5"><h2>{$Message} - {$Searchresult}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
...
{if $smarty.session.EditID and ( $smarty.session.EditID eq 1 )}
	<tr><td align="center" colspan="4" class="greentxt">{$EntryChanged} {$EntryNo} {$messageID}</td></tr>
{/if}
{if $smarty.session.DeleteID and ( $smarty.session.DeleteID eq 1 )}
	<tr><td align="center" colspan="4" class="greentxt">{$EntryDeleted} {$EntryNo} {$messageID}</td></tr>
{/if}
<tr><td></td></tr>
<tr class="mblueTD">
<td nowrap="nowrap" align="left">{$EntryNo}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC" alt="{$SortMsg} {$EntryNo} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$EntryNo} DESC" alt="{$SortMsg} {$EntryNo} DESC" /></a>&nbsp;</td>
<td nowrap="nowrap" align="left">{$Message}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Message} ASC" alt="{$SortMsg} {$Message} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Message} DESC" alt="{$SortMsg} {$Message} DESC" /></a>&nbsp;</td>
<td nowrap="nowrap" align="center" colspan="2">{$Entrys}:&nbsp;{$MaxRows}&nbsp;</td></tr>
{* Display entrys from database if $MaxRows > 0 *}
{if $MaxRows == 0}
	<tr><td align="center" colspan="5" class="grayTD">{$NoEntry}</td></tr>
{else}
{foreach from=$MessageData item=message}
	<tr class="{cycle values="grayTD,wTD"}">
	<td valign="top" align="left"><a name="{$message.MESSAGEID}" title="{$AllInformation} {$EntryNo} {$message.MESSAGEID} - {$message.DESCRIPTION}" class="ninfolink" href="info.php?messageID={$message.MESSAGEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">
	{$message.MESSAGEID}</a></td><td valign="top" align="left">
	...
	{if $smarty.session.Username and ( $smarty.session.Username == $Root or $smarty.session.Usergroup1 == $AdminGroup1 or $smarty.session.Usergroup2 == $AdminGroup2)}
		<td valign="top" align="center"><a href="edit.php?messageID={$message.MESSAGEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td></tr>
	{else}
		<td></td></tr>
	{/if}
{/foreach}
