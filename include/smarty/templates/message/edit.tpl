...
{else}
	<body onload="document.Edit.CMessage.focus();">
{/if}
...
<tr>
	...
	{if $infoID eq 9}
		[&nbsp;<a title="{$BackMsg} - {$Message} - {$Searchresult}" class="ninfolink" href="searchlist.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	{else}
		[&nbsp;<a title="{$BackMsg} - {$Message} - {$List}" class="ninfolink" href="list.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	{/if}
	</td>
</tr>
<tr><td align="center" colspan="2"><h2>{$Message} - {$Edit}</h2></td></tr>
<tr><td></td></tr>
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$messageID} ]</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="center" colspan="2"><b>{$Message}:</b></td></tr>
<tr><td valign="middle" align="center" colspan="2"><textarea title="{$Message}" class="form_textarea" name="CMessage" rows="5" cols="40">{$MESSAGE}</textarea></td></tr>
<tr><td></td></tr>
