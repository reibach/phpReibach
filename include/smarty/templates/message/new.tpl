...
{else}
	<body onload="document.New.CMessage.focus();">
{/if}
...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Message} - {$New}"
...
<tr><td align="center" colspan="2"><h2>{$Message} - {$New}</h2></td></tr>
{if $smarty.session.NewID and ( $smarty.session.NewID eq 1 )}
	<tr><td align="center" colspan="2" class="greentxt">{$NewEntry} {$EntryNo} {$MessageID}</td></tr>
	<tr><td></td></tr>
{/if}
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$MessageID+1} ]</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="center" colspan="2"><b>{$Message}:</b></td></tr>
<tr><td valign="middle" align="center" colspan="2"><textarea title="{$Message}" class="form_textarea" name="CMessage" rows="5" cols="40">{$CMessage}</textarea></td></tr>
<tr><td></td></tr>
