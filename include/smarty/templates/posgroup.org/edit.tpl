...
<tr>
	...
	[&nbsp;<a title="{$BackMsg} - {$PositionGroupSub} - {$Searchresult}" class="ninfolink" href="searchlist.php?page={$page}&amp;Description_1={$Description_1}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	</td>
</tr>
{else}
<tr>
	<td valign="middle" align="left" colspan="2">
	[&nbsp;<a title="{$BackMsg} - {$PositionGroupSub} - {$List}" class="ninfolink" href="list.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	</td>
</tr>
{/if}
<tr><td align="center" colspan="2"><h2>{$PositionGroupSub} - {$Edit}</h2></td></tr>
<tr><td></td></tr>
...
<tr><td valign="middle" align="center" colspan="2"><textarea title="{$PositionGroupSub}" class="form_textarea" name="CPosGroup" rows="5" cols="40">{$POSGROUP}</textarea></td></tr>
<tr><td></td></tr>
