...
<tr><td align="left" class="phprechnung_menu_sub"><a accesskey="1" title="{$Settings} - {$List}"
href="list.php?{$Session}">{$Settings}</a></td></tr>
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Settings} - {$Help}"
