...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Category} - {$New}"
...
<tr>
	...
	{if $infoID eq 9}
		[&nbsp;<a title="{$BackMsg} - {$Category} - {$Searchresult}" class="ninfolink" href="searchlist.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	{else}
		[&nbsp;<a title="{$BackMsg} - {$Category} - {$List}" class="ninfolink" href="list.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
	{/if}
	</td>
</tr>
<tr><td align="center" colspan="2"><h2>{$Category} - {$New}</h2></td></tr>
{if $smarty.session.NewID and ( $smarty.session.NewID eq 1 )}
	<tr><td align="center" colspan="2" class="greentxt">{$NewEntry} {$EntryNo} {$CategoryID}</td></tr>
{/if}
<tr><td></td></tr>
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$CategoryID+1} ]</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$Category}:</b>&nbsp;</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$Category}" type="text" name="CCategory" size="30" value="{$CCategory}" /></td></tr>
<tr><td></td></tr>
