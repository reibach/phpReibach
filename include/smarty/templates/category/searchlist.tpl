...
<tr><td align="center" colspan="5"><h2>{$Category} - {$Searchresult}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CATEGORYID&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC" alt="{$SortMsg} {$EntryNo} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CATEGORYID&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$EntryNo} DESC" alt="{$SortMsg} {$EntryNo} DESC" /></a>&nbsp;</td>
<td nowrap="nowrap" align="left">{$Category}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Category} ASC" alt="{$SortMsg} {$Category} ASC" /></a>&nbsp;<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Category} DESC" alt="{$SortMsg} {$Category} DESC" /></a>&nbsp;</td>
...
{foreach from=$CategoryData item=category}
	...
	<td valign="top" align="left"><a name="{$category.CATEGORYID}" title="{$AllInformation} {$EntryNo} {$category.CATEGORYID} - {$category.DESCRIPTION}" class="ninfolink" href="info.php?categoryID={$category.CATEGORYID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">
	{$category.CATEGORYID}</a></td><td valign="top" align="left">
	...
	{if $smarty.session.Username and ( $smarty.session.Username == $Root or $smarty.session.Usergroup1 == $AdminGroup1 or $smarty.session.Usergroup2 == $AdminGroup2)}
		<td valign="top" align="center"><a href="edit.php?categoryID={$category.CATEGORYID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td></tr>
	{else}
		<td></td></tr>
	{/if}
{/foreach}
