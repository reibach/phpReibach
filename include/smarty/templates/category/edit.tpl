...
{else}
	<body onload="document.Edit.CCategory.focus();">
{/if}
...
<form id="Edit" name="Edit" action="editf.php?{$Session}#{$categoryID}" method="post">
...
<tr><td align="center" colspan="2"><h2>{$Category} - {$Edit}</h2></td></tr>
<tr><td></td></tr>
<tr><td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$categoryID} ]</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$Category}:</b>&nbsp;</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$Category}" type="text" name="CCategory" size="30" value="{$CATEGORY}" /></td></tr>
<tr><td></td></tr>
