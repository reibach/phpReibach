...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="3" title="{$Category} - {$Search}"
...
<tr><td align="center" colspan="2"><h2>{$Category} - {$Search}</h2></td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%">{$Category}:&nbsp;</td><td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$Category}" type="text" name="Description_1" size="30" value="" /></td></tr>
<tr><td></td></tr>
