...
<tr><td align="center" colspan="2"><h2>{$Tax} - {$Info}</h2></td></tr>
<tr><td></td></tr>
{if $smarty.session.Username and ( $smarty.session.Username eq $Root )}
	<tr><td align="center" colspan="2">
	[&nbsp;<a title="{$Editentry}" class="nmenulink" href="edit.php?taxID={$taxID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$Edit}</a>&nbsp;]
	</td></tr>
{/if}
<tr><td></td></tr>
<tr><td align="center" colspan="2">{$AllInformation} {$EntryNo} {$taxID}</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%">{$Tax_Divide}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$TAX_DIVIDE}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$Tax_Multiply}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$TAX_MULTIPLY}</td></tr>
<tr><td valign="middle" align="right" width="40%">{$Tax_Description}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$TAX_DESCRIPTION}</td></tr>
<tr><td></td></tr>
{* Display back button *}
<tr><td valign="middle" align="center" width="100%" colspan="2">
<form action="list.php?{$Session}#{$taxID}" method="post">
