...
<tr><td align="center" colspan="5"><h2>{$Position} - {$List}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
{* Display pager if $MaxRows => $EntrysPerPage ( lines per page ) *}
{if $MaxPages}
	<tr><td align="center" colspan="5">
	{if $CurrentPage > 1 }
		<a href="{$smarty.server.PHP_SELF}?page=1&amp;Order={$Order}&amp;Sort={$Sort}&amp;Pos_Active1={$Pos_Active1}&amp;{$Session}"><img border="0" src="../images/first.png" title="{$FirstPageMsg}" alt="{$FirstPageMsg}" /></a>&nbsp;
		<a href="{$smarty.server.PHP_SELF}?page={$PrevPage}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Pos_Active1={$Pos_Active1}&amp;{$Session}"><img border="0" src="../images/prev.png" title="{$PrevPageMsg}" alt="{$PrevPageMsg}" /></a>&nbsp;
	{/if}
	{$PageMsg}&nbsp;<a title="{$PageMsg} {$CurrentPage} / {$MaxPages}" class="ninfolink" href="{$smarty.server.PHP_SELF}?page={$CurrentPage}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Pos_Active1={$Pos_Active1}&amp;{$Session}">{$CurrentPage}</a>&nbsp;/&nbsp;{$MaxPages}&nbsp;
	{if $CurrentPage < $MaxPages }
		<a href="{$smarty.server.PHP_SELF}?page={$NextPage}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Pos_Active1={$Pos_Active1}&amp;{$Session}"><img border="0" src="../images/next.png" title="{$NextPageMsg}" alt="{$NextPageMsg}" /></a>&nbsp;
		<a href="{$smarty.server.PHP_SELF}?page={$MaxPages}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Pos_Active1={$Pos_Active1}&amp;{$Session}"><img border="0" src="../images/last.png" title="{$LastPageMsg}" alt="{$LastPageMsg}" /></a>&nbsp;
	{/if}
	</td></tr>
{/if}
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POS_NAME&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$PositionName} ASC" alt="{$SortMsg} {$PositionName} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POS_NAME&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$PositionName} DESC" alt="{$SortMsg} {$PositionName} DESC" /></a>
</td>
<td nowrap="nowrap" align="left">{$PositionText}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POS_DESC&amp;Sort=ASC&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$PositionText} ASC" alt="{$SortMsg} {$PositionText} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POS_DESC&amp;Sort=DESC&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$PositionText} DESC" alt="{$SortMsg} {$PositionText} DESC" /></a>
</td>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Pos_Active1=1&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$PositionActive}" alt="{$PositionActive}" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Pos_Active1=2&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$PositionInactive}" alt="{$PositionInactive}" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Pos_Active1=3&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img border="0" src="../images/right.png" title="{$ShowAllPositions}" alt="{$ShowAllPositions}" /></a>
&nbsp;
</td>
</tr>
...
{foreach from=$Positions item=position}
	...
	{if $smarty.session.Username and ( $smarty.session.Username == $Root or $smarty.session.Usergroup1 == $AdminGroup1 or $smarty.session.Usergroup2 == $AdminGroup2)}
		...
		<td valign="top" align="center"><a href="delete.php?posID={$position.POSITIONID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Pos_Active1={$Pos_Active1}&amp;{$Session}"><img border="0" src="../images/delete.png" title="{$Deleteentry}" alt="{$Deleteentry}" /></a></td>
	{else}
		<td></td><td></td>
	{/if}
	</tr>
