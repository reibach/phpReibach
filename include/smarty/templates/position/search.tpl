...
<body onload="document.Search.Pos_Name1.focus();">
...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Position} - {$Search}"
...
<tr><td align="center" colspan="2"><h2>{$Position} - {$Search}</h2></td></tr>
<tr><td></td></tr>
<tr><td valign="top" align="right" width="40%">{$PositionName}:</td><td valign="top" align="left" width="60%"><input class="form_input" name="Pos_Name1" size="39" /></td></tr>
<tr><td valign="top" align="right" width="40%">{$PositionText}:</td><td valign="top" align="left" width="60%"><textarea class="form_textarea"  name="Pos_Desc1" rows="3" cols="37"></textarea></td></tr>
<tr><td valign="top" align="right" width="40%">{$PositionPrice} {$Currency}:</td><td valign="top" align="left" width="60%"><input class="form_input" name="Pos_Price1" size="39" /></td></tr>
<tr><td></td></tr>
<tr><td valign="top" align="center" colspan="2"><input type="submit" class="button" title="{$Search}" value="{$Search}" /></td></tr>
</table>
</form>
</td></tr>
