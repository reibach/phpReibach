...
/*
	...
	phpRaèun - vi¹ejezièni raèunovodstveni softver.
	Copyright (C) 2001 - 2015 Edy Èorak < edy at loenshotel dot de >

	Hrvatski Prijevod: 2005 - 2008 Edy Èorak
...
$a = array (
	...
	"programname" => "phpRaèun 1.6.5",
	"phprechnung" => "phpRaèun 1.6.5 - Copyright &copy; 2001 - 2015 <a class='nmenulink' title='phpRaèun Home' href='https://www.loenshotel.de/phpRechnung/' target='_blank'>&nbsp;Edy Èorak&nbsp;</a>. Sva prava pridr¾ana.",
	...
	"payment" => "Uplata",
	"cashbook" => "Raèunska knji¾ica",
	"reports" => "Izvje¹taji",
	"configuration" => "Konfiguracija",
	"message" => "Poruka",
	"method_of_payment" => "Naèin plaæanja",
	"category" => "Kategorija",
	...
	"invoice_issued" => "Za ovaj zapis je izdan raèun / ponuda",
	"payment_issued" => "Za ovaj raèun postoji uplata.<br />
		Da bi ste ovaj raèun mogli urediti, morate prvo obrisati uplatu.",
	"position_used" => "Ova pozicija se koristi u raèunima / ponudama.",
	"offer_used" => "Za ovu ponudu je izdan raèun.<br />
		Da bi ste mogli ponudu urediti, morate prvo raèun obrisati.",
	...
	"cust_method_of_payment" => "Naèin plaæanja",
	"birthday" => "Roðendan n. p. 01.01.1970",
	"select_all" => "Svi",
	"envelope" => "Envelope",
	"issue_invoice" => "Izdaj novi raèun za",
	...
	"print_output" => "Ispis",
	"company_logo" => "Grafièki znak tvrtke",
	"company_logo_width" => "©irina grafièkog znaka",
	"company_logo_height" => "Visina grafièkog znaka",
	...
	"bank_name" => "Ime banke",
	"bank_account" => "Broj tekuæeg raèuna",
	...
	"pdf_font" => "Slova",
	"pdf_text1" => "Velièina slova 1",
	"pdf_text2" => "Velièina slova 2",
	"pdf_text3" => "Velièina slova n. p. Raèun",
	...
	// Raèun
	//
	"save_invoice" => "Spremi raèun",
	"print_invoice" => "Ispi¹i raèun",
	"copy_invoice" => "Kopiraj raèun",
	"change_invoice" => "Uredi raèun",
	"open_account" => "Za platiti",
	"invoice_initials" => "RA",
	"invoice_number" => "Broj raèuna",
	"invoice_subtotal" => "Meðuisnos",
	"invoice_tax1" => "PDV. 1",
	"invoice_tax2" => "PDV. 2",
	"invoice_tax3" => "PDV. 3",
	"invoice_amount" => "Ukupna cijena",
	"transaction" => "Ulaz uplate",
	"invoice_transaction" => "Ulaz uplate za broj raèuna.",
	"open_invoice" => "Otvoreni raèuni",
	"email_invoice" => "Po¹alji raèun po E-Po¹ti za:",
	"invoice_was_send" => "Raèun je poslan po E-Po¹ti za:",
	"open_since" => "Otvoren od dan(a)",
	"invoice_deletion" => "Kroz brisanje ovog raèuna,<br />stanje raèunske knji¾ice bilo bi negativno!",
	...
	"payment_sum" => "Uplaæeno",
	"total_payment" => "Ukupno",
	"card_number" => "Broj kartice",
	"valid_thru" => "Va¾i do",
	"outstanding_payment" => "Prikazani su samo korisnici sa otvorenim raèunima.",
	"payment_error" => "Uplata postoji.",
	"payment_incorrect" => "Neva¾eæa uplata.<br />Uplata mora biti u visini raèuna.",
 	"payment_deletion" => "Kroz brisanje ove uplate,<br />stanje raèunske knji¾ice bilo bi negativno!",
	...
	"invoice_totals" => "Knjiga izlaznih raèuna",
	"booking_details" => "Knji¾enje po datumu",
	"individual_values" => "Pojedinaèni iznosi",
	"summary" => "Pregled",
	"date_from" => "od",
	"date_till" => "do",
...
$reports = array (
	...
	"invoice_ledger.php" => "Knjiga izlaznih raèuna",
	"outstanding_accounts.php" => "Otvoreni raèuni",
	"invoice_ledger_summary.php" => "Prodaja po korisniku - Pregled",
	"cashbook.php" => "Raèunska knji¾ica",
	"position_sales_summary.php" => "Prodaja po pozicijama - Pregled",
	"position_sales.php" => "Prodaja po pozicijama - Pojedinaèni iznosi",
...
$customer_reports = array (
	...
	"../reports/customer_invoices.php" => "Knjiga izlaznih raèuna",
	"../reports/customer_outstanding_accounts.php" => "Otvoreni raèuni"
);
