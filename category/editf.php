...
{
	$query1 = $db->Execute("SELECT CATEGORYID, DESCRIPTION FROM category WHERE DESCRIPTION='$CCategory' AND CATEGORYID != $categoryID");
	...
	{
		$query2 = "UPDATE category SET DESCRIPTION='$CCategory', MODIFIEDBY='$_SESSION[Username]', MODIFIED='$CurrentDateTime' WHERE CATEGORYID=$categoryID";
