...
//
$query = $db->Execute("SELECT CATEGORYID, DESCRIPTION FROM category ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
if (!$query)
	...
	// Count MaxRows
	//
	$query1 = $db->Execute("SELECT CATEGORYID FROM category");
