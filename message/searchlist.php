...
//
$query = $db->Execute("SELECT MESSAGEID, DESCRIPTION FROM message WHERE DESCRIPTION LIKE '%$Description_1%' ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
if (!$query)
	...
	// Count MaxRows
	//
	$query1 = $db->Execute("SELECT MESSAGEID, DESCRIPTION FROM message WHERE DESCRIPTION LIKE '%$Description_1%' ORDER BY $Order $Sort");
