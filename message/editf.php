...
{
	$query1 = $db->Execute("SELECT MESSAGEID, DESCRIPTION FROM message WHERE DESCRIPTION='$CMessage' AND MESSAGEID != $messageID");
	...
	{
		$query2 = "UPDATE message SET DESCRIPTION='$CMessage', MODIFIEDBY='$_SESSION[Username]', MODIFIED='$CurrentDateTime' WHERE MESSAGEID=$messageID";
