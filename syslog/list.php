...
// Get Tax Information
//
$query = $db->Execute("SELECT SYSLOGID, CREATED, DESCRIPTION FROM syslog ORDER BY $Order $Sort LIMIT $intCursor, $EntrysPerPage");
...
if (!$query)
	...
	// Count MaxRows
	//
	$query1 = $db->Execute("SELECT SYSLOGID FROM syslog");
