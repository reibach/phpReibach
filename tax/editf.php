...
{
	$query1 = $db->Execute("SELECT TAXID, TAX_DESC, TAX_DIVIDE, TAX_MULTI FROM tax WHERE TAX_DESC='$TaxDescription' AND TAX_DIVIDE='$TaxDivide' AND TAX_MULTI='$TaxMultiply' AND TAXID != $taxID");
	...
	{
		$query2 = "UPDATE tax SET TAX_DESC='$TaxDescription', TAX_DIVIDE='$TaxDivide', TAX_MULTI='$TaxMultiply', MODIFIEDBY='$_SESSION[Username]', MODIFIED='$CurrentDateTime' WHERE TAXID=$taxID";
