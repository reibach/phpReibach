...
// Delete the current license status
//
unset($_SESSION['LicenseAccepted']);

CheckUser();
CheckSession();

if(isset($_POST['license_accepted']))
{
	$license_accepted = htmlspecialchars($_POST['license_accepted'], ENT_QUOTES, $_SESSION['Charset']);
}
...
//
$_SESSION['LicenseAccepted'] = $license_accepted;
$_SESSION['LastLicenseAccepted'] = $license_accepted;
