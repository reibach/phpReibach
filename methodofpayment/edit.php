...
$smarty->assign("Title","$a[method_of_payment] - $a[edit]");

// Database connection
//
DBConnect();

// Get entrys from methodofpay table
//
...
if (!$query)
	...
	foreach($query as $f)
	{
		...
		{
			$smarty->assign("METHODOFPAYMENT",$Method_Of_Payment);
		}
	}

$smarty->display('methodofpayment/edit.tpl');
