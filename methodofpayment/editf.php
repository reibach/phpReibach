...
{
	$query1 = $db->Execute("SELECT METHODOFPAYID, DESCRIPTION FROM methodofpay WHERE DESCRIPTION='$Method_Of_Payment' AND METHODOFPAYID != $methodpayID");
	...
	{
		$query2 = "UPDATE methodofpay SET DESCRIPTION='$Method_Of_Payment', MODIFIEDBY='$_SESSION[Username]', MODIFIED='$CurrentDateTime' WHERE METHODOFPAYID=$methodpayID";
