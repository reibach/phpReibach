...
else
{
	...
	//
	DBConnect();
	$query1 = $db->Execute("SELECT METHODOFPAY FROM addressbook WHERE METHODOFPAY=$methodpayID");
	$query2 = $db->Execute("SELECT METHODOFPAYID FROM offer WHERE METHODOFPAYID=$methodpayID");
	$query3 = $db->Execute("SELECT METHODOFPAYID FROM invoice WHERE METHODOFPAYID=$methodpayID");
	$query4 = $db->Execute("SELECT METHODOFPAYID FROM payment WHERE METHODOFPAYID=$methodpayID");
	...
	{
		$query4 = "DELETE FROM methodofpay WHERE METHODOFPAYID=$methodpayID";
