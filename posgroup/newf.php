...
else
{
	...
	//
	DBConnect();	
	$query1 = $db->Execute("SELECT DESCRIPTION FROM posgroup WHERE DESCRIPTION='$CPosGroup'");
	...
	{
		$query2 = "INSERT INTO posgroup (POSGROUPID, DESCRIPTION, CREATEDBY, MODIFIEDBY, USERGROUP1, USERGROUP2, CREATED, MODIFIED)";
