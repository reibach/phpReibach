...
{
	$query1 = $db->Execute("SELECT POSGROUPID, DESCRIPTION FROM posgroup WHERE DESCRIPTION='$CPosGroup' AND POSGROUPID != $posgroupID");
	...
	{
		$query2 = "UPDATE posgroup SET DESCRIPTION='$CPosGroup', MODIFIEDBY='$_SESSION[Username]', MODIFIED='$CurrentDateTime' WHERE POSGROUPID=$posgroupID";
