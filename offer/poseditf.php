...
$query = "UPDATE tmp_offer SET MYID='$myID', OFFERID='$offerID', POSITIONID=$PosID, USERNAME='$_SESSION[Username]', POS_DESC='$Pos_Desc', POS_QUANTITY='$Pos_Quantity', POS_PRICE='$Pos_Price', POS_GROUP='$Pos_Group', TAX='$Pos_Tax', TAX_MULTI='$Pos_Tax_Multi', TAX_DIVIDE='$Pos_Tax_Divide', TAX_DESC='$Pos_Tax_Desc' WHERE TMP_OFFERID=$tmpPosID";
