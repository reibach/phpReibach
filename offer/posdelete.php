...
$query1 = $db->Execute("SELECT P.POSITIONID, P.POS_NAME, T.POSITIONID FROM article AS P, tmp_offer AS T WHERE T.POSITIONID=P.POSITIONID AND TMP_OFFERID=$tmpPosID");
